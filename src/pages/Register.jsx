        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-500">Plan events</div>
                  </div>
                </button>
                <button
                  type="button"
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-500">Sell fabrics</div>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full bg-white border border-gray-300 rounded-lg py-3 px-4 font-medium text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
              >
                Google
              </button>
              <button
